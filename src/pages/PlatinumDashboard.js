                ...
                <li className="nav-item dropdown premium-dropdown">
                  ...
                  >
                    ...
                    <li>
                      <a
                        className={`dropdown-item ${
                          activeSection === "schedule-call" ? "active" : ""
                        }`}
                        href="#"
                    ...
                    <li>
                      <a
                        className={`dropdown-item ${
                          activeSection === "feature-voting" ? "active" : ""
                        }`}
                        href="#"
                    ...
                    <li>
                      <a
                        className={`dropdown-item ${
                          activeSection === "membership-nft" ? "active" : ""
                        }`}
                        href="#"
                    ...
                    <li>
                      <a
                        className={`dropdown-item ${
                          activeSection === "journal-page" ? "active" : ""
                        }`}
                        href="#"
