    ...
    <div className="platinum-dashboard">
      ...
      <nav className="navbar navbar-platinum navbar-expand-lg navbar-dark">
        <div className="container-fluid">
          <a className="navbar-brand fw-bold" href="#">PLATINUMTRADE</a>
      ...
      <div className="container-fluid p-4">
            ...
            <div className="row header-section mb-4">
              <div className="col-md-8">
                ...
                <p className="text-white">
                  Welcome to your exclusive platinum dashboard. Access premium features, connect with
                  analysts, and elevate your trading experience.
                </p>
                  ...
                  <div className="card-body">
                    ...
                    <div className="market-data">
                      {[
                        ...
                        { pair: 'USD/JPY', bid: '135.50', ask: '135.52', trend: 'up' },
                        { pair: 'BTC/USD', bid: '63,245.00', ask: '63,250.00', trend: 'up' },
                      ...
                      <div className="chat-message">
                        ...
                        <div className="message-bubble">
                          <div className="message-text text-white">
                            Hello! How can I help with your trading strategy today?
                          </div>
        ...
        {/* {activeSection === 'voting' && <div>Feature Voting section</div>} */}
