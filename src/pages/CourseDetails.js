...
const ValourAcademy = () => {
  ...
  // The rest of the UI (sidebar, main_module, tabs, renderVideos, renderNotes, etc.) remains as is,
  // just add the renderKnowledge tab inside your accordion-container where others (resources, notes) are.
