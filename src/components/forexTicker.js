...
//         // Convert API data into the required format
//         const formattedData = [
//           { symbol: "EURUSD", value: data.rates.EUR, icon: "🇪🇺" },
//           { symbol: "BTCUSD", value: 88540, icon: "₿" }, 
//           { symbol: "ETHUSD", value: 2191.1, icon: "Ξ" },
//           { symbol: "GBPUSD", value: data.rates.GBP, icon: "🇬🇧" },
//           { symbol: "USDJPY", value: data.rates.JPY, icon: "🇯🇵" },
//           { symbol: "AUDUSD", value: data.rates.AUD, icon: "🇦🇺" },
//           { symbol: "USDCAD", value: data.rates.CAD, icon: "🇨🇦" },
//           { symbol: "USDCHF", value: data.rates.CHF, icon: "🇨🇭" },
//         ];
...
//                 <span className="fw-bold me-2">{item.symbol}</span>
//                 <span className="me-2">{item.value.toFixed(5)}</span>
//                 <span className={`d-flex align-items-center ${getChangeClass(item.value)}`}>
//                   {item.value >= 1 ? (
//                     <>
//                       <ArrowUpRight size={14} className="me-1" /> +{item.value.toFixed(4)}
//                     </>
//                   ) : (
//                     <>
//                       <ArrowDownRight size={14} className="me-1" /> {item.value.toFixed(4)}
//                     </>
//                   )}
//                 </span>
//               </span>
