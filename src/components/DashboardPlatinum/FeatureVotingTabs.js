  ...
  const activeVotingFeatures = [
    {
      ...
      description:
        "Real-time options flow data with customizable filters, unusual activity alerts, and dark pool transaction tracking.",
      votes: 142,
    ...
    },
    {
      ...
      description:
        "Automatically analyze your trading journal to identify patterns, strengths, weaknesses, and actionable insights to improve performance.",
      votes: 98,
      totalVotesNeeded: 200,
      daysRemaining: 12,
      comments: 17,
    },
    {
      ...
      description:
        "Visual tool to create, backtest, and share custom technical indicators without coding knowledge.",
      votes: 156,
      comments: 32,
    },
  ];
  ...
  const earlyAccessFeatures = [
    {
      ...
      description:
        "Real-time sentiment analysis from news, social media, and options flow with contrarian indicators.",
    ...
    },
    {
      ...
      description:
        "Backtest trading strategies across multiple assets and timeframes with detailed performance metrics.",
  ...
  const pastFeatures = [
    {
      ...
      description:
        "Visual representation of asset correlations in your portfolio to identify diversification opportunities.",
    ...
    },
    {
      ...
      description:
        "Calculate position sizes, risk-reward ratios, and portfolio exposure with advanced risk management tools.",
    ...
    },
    {
      ...
      description:
        "Follow and copy trades from top-performing platinum members with customizable risk parameters.",
      votes: 132,
      comments: 41,
  ...
  const feedbackContributions = [
    {
      ...
      status: "Implemented",
      description:
        "Your suggestion to add contrarian indicators to the sentiment dashboard has been implemented in the latest beta release.",
      date: "April 5, 2025",
    },
    {
      id: 10,
      ...
      status: "Under Review",
      description:
        "Your suggestion to add sector-based filtering to the portfolio heatmap is currently under review by our development team.",
      date: "April 2, 2025",
    },
  ];
              ...
              <div className="feature-card-content">
                ...
                <div className="feature-details">
                  <div className="feature-status-container">
                    <span
                      className={`feature-status ${feature.votingStatus
                        .toLowerCase()
                        .replace(" ", "-")}`}
                    >
                  ...
                  {feature.votingStatus === "Voting Open" && (
                    <div className="voting-progress-container">
                      <div className="voting-stats">
                        <span>
                          {feature.votes} of {feature.totalVotesNeeded} votes
                          needed
                        </span>
                        <span className="days-remaining">
                          {feature.daysRemaining} days remaining
                        </span>
                      </div>
                  ...
                  <div className="feature-actions">
                    ...
                    {feature.votingStatus === "Voting Open" && (
                      <button className="btn btn-vote">
                        <i className="bi bi-chevron-up"></i> Vote for This
                        Feature
                      </button>
                    )}
                  </div>
      ...
      {activeTab === "early-access" && (
        <div className="tab-content-voting">
          <div className="early-access-header">
            ...
            <p>
              As a platinum member, you have exclusive access to upcoming
              features before they're released to the general public. Join our
              early access program to test new features, provide feedback, and
            ...
            {earlyAccessFeatures.map((feature) => (
              <div key={feature.id} className="early-access-card">
                <div className="ea-card-header">
                  <span
                    className={`status-badge ${feature.status.toLowerCase()}`}
                  >
                    {feature.status}
                  </span>
                ...
                <div className="ea-feature-meta">
                  <div className="release-date">
                    <i className="bi bi-calendar"></i> Release:{" "}
                    {feature.releaseDate}
                  </div>
                  <div className="feedback-count">
                    <i className="bi bi-chat"></i> {feature.feedbackItems}{" "}
                    feedback items
                  </div>
                </div>
                ...
                <div key={contribution.id} className="contribution-item">
                  ...
                  <div className="contribution-details">
                    <div className="contribution-header">
                      ...
                      <span
                        className={`contribution-status ${contribution.status
                          .toLowerCase()
                          .replace(" ", "-")}`}
                      >
                        {contribution.status}
          ...
          {pastFeatures.map((feature) => (
            <div key={feature.id} className="feature-card">
              <div className="feature-card-content">
                <div className="vote-count-container">
                  <div
                    className={`status-icon ${feature.status.toLowerCase()}`}
                  >
                ...
                <div className="feature-details">
                  <div className="feature-status-container">
                    <span
                      className={`feature-status ${feature.status.toLowerCase()}`}
                    >
                      {feature.status}
                    </span>
                    <span className="feature-category">{feature.category}</span>
                  ...
                  {feature.releaseDate && (
                    <div className="release-date">
                      <i className="bi bi-calendar"></i> Released on{" "}
                      {feature.releaseDate}
                    </div>
                  )}
