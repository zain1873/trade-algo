...
const TradeJournal = () => {
  ...
  // New function to handle closing the details modal
  ...
  return (
    <div className="trade-journal-container">
      ...
      {showJournalForm ? (
        <div className="journal-form-overlay">
          <div className="journal-form-container">
            <div className="form-header">
              <h2>New Trade Entry</h2>
              <button className="close-button-modal" onClick={handleCloseForm}>
                <i className="bi bi-x-lg"></i>
              </button>
            </div>
            ...
            <form className="trade-form" onSubmit={handleSubmit}>
              ...
              <div className="form-section">
                ...
                {/* For brevity, I'm not including all form fields, but they remain unchanged */}
            ...
            <div className="entries-list">
              {journalEntries.map(entry => (
                <div key={entry.id} className="journal-entry-card">
                  ...
                  <button className="view-details-button" onClick={() => handleOpenDetails(entry)}>
                    View Details
                  </button>
                </div>
              ))}
      ...
      {/* Include the ViewJournalDetails component */}
      <ViewJournalDetails 
