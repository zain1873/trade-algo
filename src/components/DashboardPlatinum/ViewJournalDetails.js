      ...
      <div className="modal-content">
        <div className="modal-header">
          <div className="modal-title">
            <h2>{entry.symbol} {entry.tradeType === 'long' ? 'LONG' : 'SHORT'}</h2>
          ...
          <div className="details-section">
            ...
            <div className="details-grid">
              <div className="detail-item">
                ...
                <span className="detail-value">{entry.tradeType === 'long' ? 'Long' : 'Short'}</span>
              </div>
              <div className="detail-item">
                <span className="detail-label">Entry Date:</span>
                <span className="detail-value">{formatDate(entry.entryDate)}</span>
              </div>
              <div className="detail-item">
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">{formatDate(entry.exitDate)}</span>
              </div>
              <div className="detail-item">
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">{entry.riskRewardRatio || 'N/A'}</span>
              </div>
              <div className="detail-item">
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">{entry.takeProfit || 'N/A'}</span>
              </div>
            </div>
          </div>
