    ...
    <div className="session-management">
      ...
      <div className="tabs-container">
        ...
        <div className="tab-content-platinum">
          <div className={`tab-pane ${activeTab === 'upcoming' ? 'show active' : ''}`}>
            {sessions.upcoming.map(session => (
              <div key={session.id} className="session-card">
                ...
                <div className="session-actions">
                  ...
                  <button className="btn btn-link text-danger">Cancel Session</button>
                </div>
              </div>
            ))}
          </div>
          
          <div className={`tab-pane ${activeTab === 'past' ? 'show active' : ''}`}>
            {sessions.past.map(session => (
              <div key={session.id} className="session-card">
                ...
                <div className="session-actions">
                  <button className="btn btn-outline-primary">View Notes</button>
                  <button className="btn btn-outline-secondary">Download Recording</button>
                </div>
              </div>
            ))}
          </div>
