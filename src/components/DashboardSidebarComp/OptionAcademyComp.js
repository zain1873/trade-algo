...
// import LiveSessionChat from "../DashboardSidebarComp/LiveSessionChat"
...
//             <button 
//               className={`nav-link ${activeTab === 'real-time-alerts' ? 'active' : ''}`}
//               onClick={() => handleTabChange('real-time-alerts')}
//             >
//               Real-time Alerts
//             </button>
//           </li>
//           <li className="nav-item">
//             <button 
//               className={`nav-link ${activeTab === 'options-academy' ? 'active' : ''}`}
...
//           <li className="nav-item">
//             <button 
//               className={`nav-link ${activeTab === 'livestream' ? 'active' : ''}`}
...
//                     </div>
//                     <div className="">
//                         <div className="fundamentals-tag">Fundamentals: Options Intro (1/10)</div>
//                    </div>
//                     </div>
//                   </div>
...
//                     <div className="duration-info">13 minutes 54 seconds | Fundamentals</div>
//                     <h4 className="tutorial-heading">Tutorial Description</h4>
//                     <p className="tutorial-desc">In this tutorial, we will be covering the following topics:</p>
...
//                       <div key={item.id} className={`playlist-item ${item.isPlaying ? 'now-playing' : ''}`}>
//                         <div className="playlist-thumbnail">
//                           <img src={thumbnail} alt="Thumbnail" />
//                           <div className="course-tag">Fundamentals Course</div>
//                           <div className="academy-tag">Options Academy</div>
//                           {item.isPlaying && <div className="playing-tag">Now Playing</div>}
//                         </div>
...
//         {activeTab === 'real-time-alerts' && (
//           <div className="dummy-content">
//             <h3>Real-time Alerts</h3>
//             <p>This is a placeholder for Real-time Alerts content.</p>
//           </div>
//         )}
              ...
              <div className="col-md-7">
                <div className="intro-section">
                  ...
                  <div className="video-container-options">
                    ...
                    <div className="">
                        <div className="fundamentals-tag">{selectedCategory}: Options Intro (1/10)</div>
                   </div>
                    </div>
                  </div>
                  ...
                  <div className="tutorial-details">
                    <div className="duration-info">13 minutes 54 seconds | {selectedCategory}</div>
                    <h4 className="tutorial-heading">Tutorial Description</h4>
                    <p className="tutorial-desc">In this tutorial, we will be covering the following topics:</p>
                    <ul className="tutorial-topics">
                      <li>What Is An Options Contract?</li>
                  ...
                  <div className="playlist-items">
                    {playlistData.map((item) => (
                      <div key={item.id} className={`playlist-item ${item.isPlaying ? 'now-playing' : ''}`}>
                        <div className="playlist-thumbnail">
                          <img src={thumbnail} alt="Thumbnail" />
                          <div className="course-tag">{selectedCategory} Course</div>
                          <div className="academy-tag">Options Academy</div>
                          {item.isPlaying && <div className="playing-tag">Now Playing</div>}
                        </div>
                        <div className="playlist-info">
